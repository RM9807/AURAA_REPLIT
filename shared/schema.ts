...
export const userProfiles = pgTable("user_profiles", {
  ...
  age: integer("age"),
  skinTone: varchar("skin_tone", { length: 200 }),
  hairColor: varchar("hair_color", { length: 200 }),
  eyeColor: varchar("eye_color", { length: 200 }),
  dailyActivity: varchar("daily_activity", { length: 200 }),
  comfortLevel: varchar("comfort_level", { length: 100 }),
